...
| Shared logical databases | Cluster management, PostgreSQL/MySQL allocation, restricted credentials, reveal/rotation, row management, Schema Designer, customer views, backups/restores | MVA foundation implemented; SQL workspace, import/export, expanded grants, automation, diagnostics, and editable advanced objects remain tracked |
