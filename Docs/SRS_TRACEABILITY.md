...
| Shared logical databases | Cluster management, PostgreSQL/MySQL allocation, restricted credentials, reveal/rotation, row and schema management, controlled SQL, native import/export, customer views, backups/restores, access grants, automation, and live diagnostics | MVA foundation implemented; queued transfers, editable advanced objects, clone/rename/move, and package-gated external access remain tracked |
