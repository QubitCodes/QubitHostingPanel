...
| Shared logical databases | Cluster management, PostgreSQL/MySQL allocation, restricted credentials, reveal/rotation, row and schema management, controlled SQL, native import/export, customer views, backups/restores | MVA foundation implemented; expanded grants, queued transfers, automation, diagnostics, and editable advanced objects remain tracked |
