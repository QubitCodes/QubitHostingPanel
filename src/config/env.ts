...
const environmentSchema = z.object({
	...
	DATABASE_BACKUP_STORAGE_PATH: z.string().trim().min(1).default('storage/database-backups'),
	DATABASE_BACKUP_COMMAND_TIMEOUT_SECONDS: z.coerce.number().int().min(30).max(86400).default(3600),
	...
	COOLIFY_GITHUB_APP_UUID: optionalEnvironmentSecret,
