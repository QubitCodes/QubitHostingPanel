...
const environmentSchema = z
	.object({
		...
		DATABASE_TRANSFER_STORAGE_PATH: z.string().trim().min(1).default('storage/database-transfers'),
		DATABASE_TRANSFER_RETENTION_HOURS: z.coerce.number().int().min(1).max(720).default(24),
		DATABASE_EXTERNAL_GATEWAY_HOST: optionalEnvironmentSecret,
