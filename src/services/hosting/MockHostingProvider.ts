...
export class MockHostingProvider implements HostingProvider {
	public async controlApplication(
		...
		return { deploymentId: `mock-${action}` };
	}
	...
	public async provisionApplication(
		...
		return Promise.resolve({
			id: `mock-app-${input.workspaceId}`,
			publicUrl: `https://${input.name}.mock.invalid`,
			status: 'succeeded',
		});
	}
	...
	public async getApplicationLogs(): Promise<string> {
		return 'Mock application is running.';
	}
	public async deleteApplication(): Promise<void> {}
	public async listApplicationDeployments(): Promise<
		readonly ProviderDeployment[]
	> {
		return [];
	}
	public async getApplicationState(): Promise<ProviderApplicationState> {
	...
	public async getApplicationDeployment(
		...
		return {
			...
			status: 'finished',
			trigger: 'manual',
			logs: 'Mock deployment completed.',
		};
	}
	public async updateApplicationSettings(): Promise<void> {}

	public async updateApplicationDomains(): Promise<void> {
		return Promise.resolve();
	}
	public async createApplicationScheduledTask(
		...
		return { ...input, uuid: crypto.randomUUID() };
	}
	public async updateApplicationScheduledTask(
		...
		return { ...input, uuid: taskId };
	}
	public async deleteApplicationScheduledTask(): Promise<void> {
		return Promise.resolve();
	}
	public async listApplicationScheduledTaskExecutions(): Promise<
		readonly ProviderScheduledTaskExecution[]
	> {
		return [];
	}
}
