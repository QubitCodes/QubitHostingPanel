...
export default [
	...
	layout('layouts/customer.tsx', [
		...
		route('dashboard/databases/:databaseId', 'pages/customer/database-detail.tsx'),
	...
	layout('layouts/application.tsx', [
		...
		route('admin/customers/:workspaceId/usage', 'pages/admin/customer-usage.tsx'),
	...
	...prefix('api/v1', [
		...
		route('workspaces/:workspaceId/billing-profiles', 'api/v1/workspaces/billing-profiles.ts'),
		route('workspaces/:workspaceId/ownership-transfer', 'api/v1/workspaces/ownership-transfer.ts'),
		route('workspaces/:workspaceId/subscription/cancellation', 'api/v1/workspaces/subscription-cancellation.ts'),
		route('ownership-transfers', 'api/v1/workspaces/ownership-transfers.ts'),
		route('ownership-transfers/:transferId/respond', 'api/v1/workspaces/ownership-transfer-response.ts'),
		...
		route('workspaces/:workspaceId/databases', 'api/v1/workspaces/databases/index.ts'),
		route('workspaces/:workspaceId/databases/:databaseId/credentials', 'api/v1/workspaces/databases/credentials.ts'),
		route('workspaces/:workspaceId/databases/:databaseId/rotate', 'api/v1/workspaces/databases/rotate.ts'),
		route('workspaces/:workspaceId/databases/:databaseId/backups', 'api/v1/workspaces/databases/backups/index.ts'),
		route('workspaces/:workspaceId/databases/:databaseId/backups/:backupId', 'api/v1/workspaces/databases/backups/detail.ts'),
		route('workspaces/:workspaceId/databases/:databaseId/backups/:backupId/restore', 'api/v1/workspaces/databases/backups/restore.ts'),
		...
		route('workspaces/:workspaceId/domains/:domainId/dns', 'api/v1/workspaces/applications/domain-dns.ts'),
		route('workspaces/:workspaceId/domains/:domainId/dns/import', 'api/v1/workspaces/applications/domain-dns-import.ts'),
		route('workspaces/:workspaceId/domains/:domainId/dns/records', 'api/v1/workspaces/applications/domain-dns-records.ts'),
		route('workspaces/:workspaceId/domains/:domainId/dns/records/:recordId', 'api/v1/workspaces/applications/domain-dns-record.ts'),
		...
		route('operations/provider/connections', 'api/v1/operations/provider-connections.ts'),
		route('operations/platform-settings', 'api/v1/operations/platform-settings.ts'),
		route('operations/platform-settings/dns-providers', 'api/v1/operations/dns-providers.ts'),
		route('operations/platform-settings/dns-providers/:provider', 'api/v1/operations/dns-provider.ts'),
		route('operations/platform-settings/dns-providers/:provider/validate', 'api/v1/operations/dns-provider-validate.ts'),
		route('operations/platform-settings/verify', 'api/v1/operations/platform-settings-verify.ts'),
		route('operations/provider/connections/:connectionId/validate', 'api/v1/operations/provider-validate.ts'),
		route('operations/provider/connections/:connectionId/rotate', 'api/v1/operations/provider-rotate.ts'),
		route('operations/provider/connections/:connectionId/reconcile', 'api/v1/operations/provider-reconcile.ts'),
		route('operations/runtime-images', 'api/v1/operations/runtime-images.ts'),
		route('operations/runtime-images/:imageId', 'api/v1/operations/runtime-image.ts'),
		route('operations/customer-workspaces', 'api/v1/operations/customer-workspaces.ts'),
		route('operations/customer-workspaces/:workspaceId', 'api/v1/operations/customer-workspace.ts'),
		route('operations/customer-workspaces/:workspaceId/subscription', 'api/v1/operations/customer-subscription.ts'),
		route('operations/customer-workspaces/:workspaceId/add-ons', 'api/v1/operations/customer-add-ons.ts'),
		route('operations/customer-workspaces/:workspaceId/add-ons/:itemId', 'api/v1/operations/customer-add-on.ts'),
		route('operations/customer-workspaces/:workspaceId/usage', 'api/v1/operations/customer-usage.ts'),
		route('operations/customer-workspaces/:workspaceId/usage/overrides/:overrideId', 'api/v1/operations/customer-usage-override.ts'),
