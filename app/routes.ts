...
export default [
	...
	layout('layouts/application.tsx', [
		...
		route(
			'admin/customers/users/:userId/workspaces/:workspaceId',
			'pages/admin/customer-resources.tsx',
		),
		route(
			'admin/customers/users/:userId/workspaces/:workspaceId/applications/:applicationId/files',
			'pages/admin/customer-application-files.tsx',
		),
	...
	...prefix('api/v1', [
		...
		route(
			...
			'api/v1/workspaces/databases/detail.ts',
		),
		route(
