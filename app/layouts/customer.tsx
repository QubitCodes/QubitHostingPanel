import { CreditCard, LayoutDashboard, LogOut, ServerCog, ShieldCheck } from 'lucide-react';
...
export default function CustomerLayout() {
	...
	const navigation = [{ icon: LayoutDashboard, label: 'Overview', to: '/dashboard' }, { icon: ServerCog, label: 'Subscription', to: '/dashboard/subscription' }, { icon: CreditCard, label: 'Billing', to: '/dashboard/billing' }, { icon: ShieldCheck, label: 'Security', to: '/dashboard/security' }];
