...
export default function CustomerLayout() {
	...
	const [authUser, setAuthUser] = useState<{ countryCode?: string; displayName?: string; hasAdminAccess?: boolean; hasCustomerDashboardAccess?: boolean; mobile?: string; mobileE164?: string }>({});
