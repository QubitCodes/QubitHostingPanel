...
export default function CustomerLayout() {
	...
	const navigation = [{ icon: LayoutDashboard, label: 'Overview', to: '/dashboard' }, { icon: Boxes, label: 'Applications', to: '/dashboard/applications' }, { icon: Database, label: 'Databases', to: '/dashboard/databases' }, { icon: BarChart3, label: 'Usage', to: '/dashboard/usage' }, { icon: ServerCog, label: 'Subscription', to: '/dashboard/subscription' }, { icon: CreditCard, label: 'Billing', to: '/dashboard/billing' }, { icon: Settings2, label: 'Workspace', to: '/dashboard/workspace' }, { icon: ShieldCheck, label: 'Security', to: '/dashboard/security' }];
