...
const FAQS = [
	...
	['Do I need another password?', 'No. Ghost Deploy uses a verified WhatsApp OTP and device-aware, revocable sessions.'],
	...
	return <main className="min-h-screen overflow-hidden bg-app-canvas text-app-text">
		<header className="sticky top-0 z-50 border-b border-brand-primary/10 bg-app-canvas/90 backdrop-blur-xl dark:border-white/10">
			<div className="mx-auto flex h-20 max-w-[90rem] items-center justify-between px-5 sm:px-8 lg:px-12">
				<a className="flex items-center gap-3" href="#top"><span className="grid size-10 place-items-center rounded-xl bg-brand-primary text-lg font-black text-brand-action">G</span><span><span className="block text-sm font-bold tracking-tight">Ghost Deploy</span><span className="block text-[10px] font-semibold uppercase tracking-[.2em] text-app-muted">Managed cloud</span></span></a>
