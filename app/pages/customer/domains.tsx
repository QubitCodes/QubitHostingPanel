...
interface DomainDetail {
  ...
  zone: { nameservers: string[]; status: string };
}
interface ApiBody<T> {
  data?: T;
  message: string;
            ...
            <div className="mt-6">
              ...
              {tab === "dns" && (
                <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      <div>
                        ...
                        <p className="text-sm text-app-muted">
                          Provision, change nameservers, then refresh
                          delegation.
                        </p>
                      </div>
                  ...
                  <form
                    className="grid gap-3 rounded-2xl border border-brand-primary/10 p-5 sm:grid-cols-5"
                    onSubmit={(event) => {
                      event.preventDefault();
                  ...
                  >
                    ...
                    <input
                      className="rounded-xl border border-brand-primary/15 bg-app-canvas px-3 py-2 sm:col-span-2"
                      name="content"
                      placeholder="Value"
                      required
                    />
                    ...
                    />
                    <button
                      className="rounded-xl bg-brand-action px-4 py-2 font-bold text-brand-ink sm:col-span-5"
                      disabled={working}
                    >
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            <button
                              ...
                              disabled={
                                record.source === "platform_managed" || working
                              }
