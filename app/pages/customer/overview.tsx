...
export default function CustomerOverviewPage() {
	...
	useEffect(() => {
		...
		void Promise.all([
			dashboardData<Resource[]>(`/api/v1/workspaces/${activePublicId}/resources`),
			dashboardData<WorkspaceDetail>(`/api/v1/workspaces/${activePublicId}`),
		]).then(([resourceRows, workspaceDetail]) => {
